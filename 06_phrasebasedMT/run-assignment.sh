...
SCRIPT_DIR='.'
OUT_DIR=output
TRAIN_DATA=data/en-de/train.en-de.low.filt
mkdir -p $OUT_DIR

# *** Train n-gram language model and create an FST
#echo python $SCRIPT_DIR/train-ngram.py $TRAIN_DATA.en $OUT_DIR/ngram-fst.txt
...
echo python $SCRIPT_DIR/phrase-extract.py $TRAIN_DATA.de $TRAIN_DATA.en $OUT_DIR/alignment.txt $OUT_DIR/phrase.txt
